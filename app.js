...
/* Bellagio-style betting spots: [left%, top%, rotation]. Seat 5 (index 3) is our player. */
const SPOTS = [
...
(function buildSpots() {
  for (const [x, y, r] of SPOTS) {
    ...
    s.innerHTML =
      '<div class="bt-circle"><span>B</span></div>' +
      '<div class="sb sb1">☘</div><div class="sb sb2">BB</div>';
...
async function runScene1() {
  ...
  await titleCard('PHASE 01 / 06', 'Computer Vision Capture',
    'One overhead camera per table on the Bellagio Las Vegas casino floor. Every card, chip, gesture and payout — detected, classified and scored in real time. No pit clipboard. No guesswork.');
  ...
  await sleep(800);
  logEvent('FACE', 'Identity: MGM Rewards match — M. Torres (PEARL)', '');
...
async function runSceneSurv() {
  ...
  await sleep(400);
  cvBox(39.3, 63.2, 18.5, 17.5, 'BLACKJACK \u00b7 PAYS 6:5', 'warn');
  ...
  addIncident('warn', 'Blackjack short-pay \u2014 seat 3', '6:5 on $100 paid as $100 \u00b7 corrected at the table \u00b7 dispute and comp giveback avoided', '+$20');
  bumpProtected(25);
  await sleep(1400);
...
async function runScene2() {
  ...
  try {
    ...
    $('pfTier').textContent = 'MGM REWARDS · PEARL · #4187';
    ...
    $('pipeNote').innerHTML =
      `<span class="hl">▸</span> PMS: Fountain View Suite 4208, <span class="hl">checkout tomorrow 11:00</span><br>` +
      `<span class="hl">▸</span> 6 trips / 12 mo · rated play → <span class="hl">73,680 Tier Credits</span><br>` +
      `<span class="hl">▸</span> 1,320 Tier Credits short of <span class="hl">GOLD</span> (75,000)<br>` +
...
const INTEL_COMP = {
  ...
  inputLines: [
    ...
    'tier           : <b>PEARL</b> · MGM Rewards',
    'tier_credits   : <b>73,680</b> · <span class="warn">1,320 short of GOLD</span>',
    'live_position  : <b>PIT 4 · BJ-12 · SEAT 5</b>',
    ...
    'room_status    : Fountain View Ste 4208 · <span class="bad">CHECKOUT 11:00</span>',
  ...
  actions: [
    { name: 'Extend suite comp +2 nights — Fountain View Suite', sub: '0.91 accept × 0.68 stay × $1,086 wknd theo',
    ...
    { name: 'O by Cirque du Soleil — Saturday', sub: '0.74 accept × $605 extra-session theo',
      gain: '+$448', cost: '−$150', ev: '+$298', pct: 72, ok: true },
    { name: 'Dinner for two — Jasmine', sub: '0.88 accept × $245 late-night play after dinner',
  ...
  notifHTML: `
    ...
    <div class="notif-title">Michael Torres — Pearl</div>
    <div class="notif-body">
      At <b>BJ-12, Pit 4</b> right now · down $285 tonight.<br>
      Offer: <b>extend suite comp 2 nights</b> (Fountain View Suite 4208).
    </div>
    <div class="notif-why">
  ...
  toasts: [
    '<b>✓ PMS</b> — Fountain View Suite 4208 extended through Thursday',
    '<b>✓ CRM</b> — offer sent via MGM Rewards app · read 21:29',
...
const INTEL_AP = {
  ...
  inputLines: [
    ...
    'tier           : <b>SAPPHIRE</b> · account 11 days old',
    'live_position  : <b>PIT 4 · BJ-12 · SEAT 5</b>',
  ...
  notifHTML: `
    ...
    <div class="notif-title">J. Chen — Sapphire · AP confirmed 94%</div>
    <div class="notif-body">
      At <b>BJ-12, Pit 4</b> right now · spread $25→$300 with the count.<br>
  ...
  toasts: [
    '<b>✓ PIT</b> — supervisor P. Ruiz dispatched to BJ-12',
...
async function runSceneAP() {
  ...
  await sleep(700);
  logEvent('FACE', 'Identity: J. Chen — SAPPHIRE · account 11 days old', 'alert');
...
const FLOOR_TABLES = [
  ['BJ-05','BLACKJACK',310,4], ['BJ-12','BLACKJACK',412,5], ['BJ-09','BLACKJACK',280,3], ['BJ-11','BLACKJACK',195,4],
...
const FLOOR_EVENTS = [
  ['BJ-12', 'ok',    'Comp approved — M. Torres · +$412 EV',
   '21:29 · <b>BJ-12</b> — Suite comp approved · <b class="good">+$412 EV</b>'],
  ...
  ['BJ-12', 'alert', 'AP flat-bet enforced — $7.4K protected',
   '22:56 · <b>BJ-12</b> — Flat-bet enforced · #2291 · <b class="good">$7.4K protected</b>'],
];
...
async function runSceneFloor() {
  ...
  /* stats bar */
  const stats = [
    ['TABLES LIVE', '92'], ['RATED SESSIONS', '61'], ['THEO TODAY', '$438K'],
